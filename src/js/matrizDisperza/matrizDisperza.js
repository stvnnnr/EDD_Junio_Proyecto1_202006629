...
export class matrizDisperza {
    ...
    graficar() {
        ...
        while (pivote != null) {
            ...
            while (pivotNodo != null) {
                ...
                if (pivotNodo.valor != "") {
                    texto += "\nnode[label=\"" + pivotNodo.valor.nombre + "\" fillcolor=\"white\" pos=\"" + yNodo + ",-" + x + "!\" shape=box]i" + pivotNodo.x + "_" + pivotNodo.y + ";"
                } else {
    ...
    grafLindo() {
        var texto = "digraph G{bgcolor = \"none\"\nnode[shape=box, width=0.7, height=0.7, fontname=\"Arial\",  bgcolor = \"white\"]\nedge[style = \"bold\"]\n"
        texto += "node[label = \"Conexiones\" bgcolor = \"Red\" fillcolor=\"Red\" pos = \"-1,1!\"]raiz;"
        texto += "label = \"Thriller\"  \nfontname=\"Arial Black\" \nfontsize=\"25pt\" \n"
        var pivot = this.filas.cabeza
        var xMoment = 0
        while (pivot != null) {
            texto += "\nnode[label=\"F" + pivot.id + "\" bgcolor=\"white\" pos=\"-1,-" + xMoment + "!\" shape=box]x" + pivot.id + ";"
            pivot = pivot.siguiente
            xMoment++
        }
        pivot = this.filas.cabeza
        ...
        var yMoment = 0
        while (pivotDos != null) {
            texto += "\nnode[label=\"C" + pivotDos.id + "\" bgcolor=\"white\" pos=\"" + yMoment + ",1!\" shape=box]y" + pivotDos.id + ";"
            pivotDos = pivotDos.siguiente
            yMoment++
        }
        var pivpiv = this.columnas.cabeza
        ...
        while (pivote != null) {
            ...
            while (pivotNodo != null) {
                ...
                if (pivotNodo.valor != "") {
                    texto += "\nnode[label=\"" + pivotNodo.valor.nombre + "\" bgcolor=\"white\" pos=\"" + yNodo + ",-" + x + "!\" shape=box]i" + pivotNodo.x + "_" + pivotNodo.y + ";"
                } else {
                    texto += "\nnode[label=\"\" bgcolor=\"white\" pos=\"" + yNodo + ",-" + x + "!\" shape=box]i" + pivotNodo.x + "_" + pivotNodo.y + ";"
                }
                pivotNodo = pivotNodo.derecha
            }
            pivotNodo = pivote.pass
        ...
        texto += "\n}"
        console.log(texto)
        d3.select("#lindaDisper").graphviz()
            .width(1400)
            .height(1400)
            .engine('neato')
            .renderDot(texto)
...
// // matrix.recorerrFilas(2)
// matrix.recorerrColumnas(3)
// matrix.graficar()

// var filas = new listaCabecera("Fila")
// var Uno = new nodoCabecera(8)
// var Dos = new nodoCabecera(6)
// var Tres = new nodoCabecera(10)
// var Cuatro = new nodoCabecera(7)
// filas.insertarCabecita(Uno)
// filas.insertarCabecita(Dos)
// filas.insertarCabecita(Tres)
// filas.insertarCabecita(Cuatro)
// filas.recorrer()
